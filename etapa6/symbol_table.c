...
int add_var(STACK *stack, char *type, node_t *nodo1, node_t *nodo2, TOKEN_INFO *valor1, TOKEN_INFO *valor2, int *desloc)
{
    node_t *nodo;
    node_t *aux;
    HASH_TBL *entry;
    ...
    if ((strcmp(type, "global_static") == 0) || (strcmp(type, "global_non_static") == 0))
    {
        ...
        do
        {
            ...
            else
            {
                ...
                conteudo->is_global = 1;
                conteudo->deslocamento = *desloc;
...
int add_function_to_table(STACK *stack, TOKEN_INFO *indentificador, node_t *node, int static_func, node_t *func_params, int desloc, int *list_size)
{ 
...
int add_func_arg_to_table(STACK *stack, TOKEN_INFO *identificador, node_t *type, int is_const, int desloc)
{
    ...
    content->is_global = 0; // etapa 5
    content->deslocamento = desloc;
