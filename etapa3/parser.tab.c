...
static const yytype_uint8 yyrline[] =
{
     ...
     108,   108,   109,   109,   109,   111,   114,   115,   118,   119,
     122,   123,   124,   125,   128,   129,   132,   133,   134,   135,
     138,   139,   140,   141,   142,   143,   146,   147,   148,   149,
     152,   153,   154,   155,   158,   159,   162,   163,   166,   167,
     168,   171,   174,   175,   176,   179,   180,   182,   182,   184,
     184,   184,   187,   188,   191,   192,   195,   196,   198,   198,
...
#line 98 "parser.y" /* yacc.c:1646  */
    { char str[16]; sprintf(str,"%.2f",(yyvsp[0].valor_lexico)->valor.f); (yyval.no) = cria_nodo(str,(yyvsp[0].valor_lexico)); }
